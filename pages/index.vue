        ...
        <div class="flex flex-wrap gap-4">
          ...
          <div class="flex flex-1  flex-wrap gap-4">
            ...
            >
              ...
              />
              <h1 class="font-extrabold text-dark200">{{ (totalIncome * 0.04).toFixed(2) }} {{ $t("etb") }}</h1>
...
const { result: fetchOrder, onError: fetchOrderError } =
  useCustomQuery(fetchOrderDataGql);
onError((error) => {
  console.log(error);
});
